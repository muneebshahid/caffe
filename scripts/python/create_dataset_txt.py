...
parser.add_argument("target_folder_path", help="Path to the target folder, where txt file will be created (not used for freiburg)")
...
if args.process_mich:
	...
	summer = []
	winter = []
	target_folder_winter = folder_path_frei + 'dataset/winter/'
	target_folder_summer = folder_path_frei + 'dataset/summer/'
	with open(folder_path_frei + 'exported_season_match.txt', "r") as lines:
	...
	for t_file in target_files:
		with open(args.target_folder_path + t_file, 'w') as f:
